                                        ...
                                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('edit.employee',$item->id)}}" class="btn btn-soft-info rounded-pill waves-effect waves-light" fdprocessedid="io1mu">EDIT</a>

                                                        <a href="{{route('delete.employee',$item->id)}}" class="btn btn-soft-danger rounded-pill waves-effect waves-light"fdprocessedid="5krrt" id="delete">DEL</a>
                                                    </td>
